  ...
  <section class="section">
    ...
    <div class="section-body">
      ...
      <p class="section-lead">
        Di halaman ini Anda dapat membuat tentang baru
      </p>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="<?= base_url('tentang/tambah'); ?>" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="">
                    <textarea name="isi" id="berita" value="<?= set_value('isi'); ?>">Isi tentang</textarea>
