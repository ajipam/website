<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="menu-header">Data Upenkom</li>
      <li class="nav-item dropdown">
      ...
      <li class="nav-item dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-newspaper"></i> <span>Tentang Kami</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link beep beep-sidebar" href="<?= base_url('tentang/tambah'); ?>">Tulis tentang</a></li>
          <li><a class="nav-link " href="<?= base_url('tentang'); ?>">Daftar tentang</a></li>
        </ul>
      <li class="nav-item dropdown">
      ...
      <li class="nav-item dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-cog"></i> <span>Metode</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link beep beep-sidebar" href="<?= base_url('metode/tambah'); ?>">Tulis Metode</a></li>
          <li><a class="nav-link " href="<?= base_url('metode'); ?>">Daftar Metode</a></li>
        </ul>
      </li>
      <li class="nav-item dropdown">
