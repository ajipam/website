      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-6 footer-links">
          ...
          <ul>
            ...
            <li><i class="bi bi-chevron-right"></i> <a href="<?= base_url('home/#about'); ?>">About us</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="<?= base_url('home/#services'); ?>">Services</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="<?= base_url('home/#clients'); ?>">Portofolio</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="<?= base_url('home/blog'); ?>">Blog</a></li>
          </ul>
        </div>
        ...
        <!--<div class="col-lg-2 col-6 footer-links">
          ...
          <ul>
            <?php foreach ($layanan as $key => $value) : ?>
              <li><i class="bi bi-chevron-right"></i> <a href="<?= base_url('home/#services'); ?>"><?= $value->judul_layanan; ?></a></li>
            <?php endforeach; ?>
          </ul>
        </div>-->
